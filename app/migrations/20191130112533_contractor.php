...
class Contractor extends AbstractMigration
{
    public function change()
    {
        $this->table('contractor_status', ['id' => false])
        ...
        $this->table('contractor', ['id' => false])
            ->addColumn('id', 'uuid')
            ->addColumn('client_id', 'uuid', ['null' => false])
            ...
            ->addForeignKey('status_id', 'contractor_status', 'id', ['delete' => 'NO_ACTION', 'update' => 'NO_ACTION'])
            ->create()
        ;

        $this->table('contractor_contact', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ...
            ->addColumn('updated_at', 'timestamp', ['timezone' => true, 'null' => true])
            ->addIndex(['id'], ['unique' => true])
            ->addForeignKey('contractor_id', 'contractor', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->create()
        ;

        $this->table('contractor_bank_account', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ->addColumn('contractor_id', 'uuid', ['null' => false])
            ->addColumn('creator_id', 'uuid', ['null' => false])
        ...
        $this->table('contractor_group', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ->addColumn('client_id', 'uuid', ['null' => false])
            ->addColumn('creator_id', 'uuid', ['null' => false])
            ->addColumn('name', 'string', ['limit' => 200, 'null' => false])
        ...
        $this->table('contractor_groups', ['id' => false])
            ->addColumn('contractor_id', 'uuid', ['null' => false])
            ->addColumn('group_id', 'uuid', ['null' => false])
            ->addIndex(['contractor_id', 'group_id'], ['unique' => true])
            ->addForeignKey('contractor_id', 'contractor', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->addForeignKey('group_id', 'contractor_group', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->create()
        ;

        $this->table('contractor_package_doc', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ->addColumn('contractor_id', 'uuid', ['null' => false])
            ->addColumn('creator_id', 'uuid', ['null' => false])
            ->addColumn('name', 'string', ['limit' => 255, 'null' => false])
            ...
            ->addColumn('updated_at', 'timestamp', ['timezone' => true, 'null' => true])
            ->addIndex(['id'], ['unique' => true])
            ->addIndex(['contractor_id', 'name'], ['unique' => true])
            ->addForeignKey('contractor_id', 'contractor', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->create()
        ;

        $this->table('contractor_package_doc_files', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ...
            ->addForeignKey('package_doc_id', 'contractor_package_doc', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->create()
        ;

        $this->table('contractor_custom_field', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ->addColumn('client_id', 'uuid', ['null' => false])
            ->addColumn('creator_id', 'uuid', ['null' => false])
            ->addColumn('name', 'string', ['limit' => 200, 'null' => false])
        ...
        $this->table('contractor_custom_field_values', ['id' => false])
            ->addColumn('id', 'uuid', ['null' => false])
            ->addColumn('custom_field_id', 'uuid', ['null' => false])
            ->addColumn('contractor_id', 'uuid', ['null' => false])
            ->addColumn('value', 'text', ['null' => false])
            ->addIndex(['id'], ['unique' => true])
            ->addIndex(['custom_field_id', 'contractor_id'], ['unique' => true])
            ->addForeignKey('custom_field_id', 'contractor_custom_field', 'id', ['delete' => 'CASCADE', 'update' => 'NO_ACTION'])
            ->addForeignKey('contractor_id', 'contractor', 'id', ['delete' => 'NO_ACTION', 'update' => 'NO_ACTION'])
            ->create()
        ;
    }
}
