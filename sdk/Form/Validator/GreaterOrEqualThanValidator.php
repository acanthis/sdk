...
class GreaterOrEqualThanValidator implements ValidatorInterface
{
    use ErrorsTrait;

    private const ERROR = 'form_validation_cannotBeGreaterOrEqual';
    ...
    public function setValue(int $value): GreaterOrEqualThanValidator
    {
        $this->value = $value;
