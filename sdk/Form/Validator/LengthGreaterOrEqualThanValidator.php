...
class LengthGreaterOrEqualThanValidator implements ValidatorInterface
{
    use ErrorsTrait;

    private const ERROR = 'form_validation_lengthMustBeGreaterOrEqual';
    ...
    public function setLength(int $length): LengthGreaterOrEqualThanValidator
    {
        $this->length = $length;
